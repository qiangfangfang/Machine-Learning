...
def chooseBestFeatureToSplit(dataSet):
    ...
    for i in range(numFeatures):
        ...
        infoGainRatio = (baseEntropy - newEntropy)/split_info  # 求信息增益率
        if infoGainRatio > bestInfoGainRatio:  # 如果此信息增益大于之前的记录的信息增益
            bestInfoGainRatio = infoGainRatio  # 更新最大的信息增益
            bestFeature_index = i
    return bestFeature_index,bestInfoGainRatio
