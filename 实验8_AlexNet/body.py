...
# 数据路径 根据实际情况修改
sourth_path_daisy =\
r'F:\Class_Code\Pytorch_code\data_set\flower_data\source\daisy'
sourth_path_roses =\
r'F:\Class_Code\Pytorch_code\data_set\flower_data\source\roses'
aim_dir_daisy =\
r'F:\Class_Code\Pytorch_code\data_set\flower_data\Enhance\daisy'
aim_dir_roses = \
r'F:\Class_Code\Pytorch_code\data_set\flower_data\Enhance\daisy'
aim_dir_roses = \
 r'F:\Class_Code\Pytorch_code\data_set\flower_data\Enhance\roses'
       ...
       for i in file_list:  # 对目标文件夹内的文件 进行遍历
           ...
           # (2) 颜色变换
                ...
                transforms.ColorJitter(
                    ...
                    transforms.Resize(size)])
       # brightness(亮度)、contrast(对比度)、saturation(饱和 度)、hue(色调)
                img2 = transform2(img)
